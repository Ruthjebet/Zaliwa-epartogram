...
export default function Login() {
    return (
        ...
        <div className='bg-fuchsia-100 rounded-2xl shadow-2xl flex w-full place-items-center' >
            ...
            <div className=' w-1/2 p-5 bg-fuchsia-100 rounded-tl-2xl rounded-bl-2xl  object-center py-36 px-8 justify-center items-center h-full '>
            ...
            <div className='w-1/2 p-5 bg-white text-purple-800 py-36 px-8 h-full ' >
                ...
                <div className='text-left p-15 mb-2 w-full '>
                    ...
                    <div className='flex-col items-center '>
                        <div className='flex items-center bg-gray-100  p-3  mb-3'>
                            ...
                            <input type="email" name='email' required placeholder='johndoe@gmail.com' className='text-gray-400 bg-gray-100 outline-none flex-1'></input>
                        </div>
